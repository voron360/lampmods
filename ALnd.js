(function() {
    ...
    function component(object) {
        ...
        this.externalids = function() {
            return new Promise(function(resolve, reject) {
                if (!object.movie.imdb_id || !object.movie.kinopoisk_id) {
                    ...
                    var url = window.abu_localhost + 'externalids?' + query.join('&');
        ...
        this.lifeSource = function() {
            var _this2 = this;
            return new Promise(function(resolve, reject) {
                var url = _this2.requestParams(window.abu_localhost + 'lifeevents');
                var red = false;
        ...
        this.createSource = function() {
            var _this3 = this;
            return new Promise(function(resolve, reject) {
                var url = _this3.requestParams(window.abu_localhost + 'lite/events?life=true');
    ...
    if (!window.abu_plugin) startPlugin();
